export const experienceConfig = [
  {
    ...
    description: [
      ...
      "Summarist was constructed utilizing NextJs and TypeScript, incorporating global state management to adeptly handle intricate state logic. Financial transactions are securely managed through the Stripe payment system, while backend operations are efficiently executed using Firebase. This strategic use of contemporary technologies ensured an engaging, user-centric experience, optimized for performance and reliability.",
      "Meticulously crafted highly efficient and reusable code by strategically implementing dependency injection, ensuring code isolation, fostering local reasoning, maintaining clear module boundaries, enabling swift development cycles, and ensuring rigorous testing. Further, I emphasized deterministic behavior and type safety, underscoring my commitment to producing robust, maintainable, and secure code.",
    ],
    date: "Aug 2022 - Jan 2023",
  },
  {
    name: "We-Mu Frontend Developer Agency",
